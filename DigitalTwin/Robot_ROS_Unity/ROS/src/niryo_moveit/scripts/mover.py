...
from niryo_moveit.srv import MoverService, MoverServiceRequest, MoverServiceResponse, GotoService, GotoServiceRequest, GotoServiceResponse
...
def plan_go_to(req):
    ...
    pose = plan_trajectory(move_group, req.target_pose, current_robot_joint_configuration)

    previous_ending_joint_angles = pose.joint_trajectory.points[-1].positions
...
def moveit_server():
    ...
    s2 = rospy.Service('niryo_goto', GotoService, plan_go_to)
    print("Ready to plan")
    rospy.spin()
